...
const CHANNELS = {
  // グループステージ
  1:  'NHK総合',       // メキシコ×南アフリカ 6/12
  5:  'NHK総合',       // カタール×スイス 6/14
  6:  'フジテレビ',    // ブラジル×モロッコ 6/14
  8:  '日テレ',        // オーストラリア×トルコ 6/14
  10: 'NHK総合',       // オランダ×日本 6/15
  13: 'NHK総合',       // スペイン×カーボベルデ 6/16
  17: 'フジテレビ',    // フランス×セネガル 6/17
  19: 'NHK総合',       // アルゼンチン×アルジェリア 6/17
  25: '日テレ',        // チェコ×南アフリカ 6/19
  28: 'NHK総合',       // メキシコ×韓国 6/19
  29: 'NHK総合',       // アメリカ×オーストラリア 6/20
  30: 'フジテレビ',    // スコットランド×モロッコ 6/20
  33: 'NHK総合',       // オランダ×スウェーデン 6/21
  34: '日テレ',        // ドイツ×コートジボワール 6/21
  36: '日テレ・NHK BS', // チュニジア×日本 6/21
  37: 'NHK総合',       // スペイン×サウジアラビア 6/22
  43: 'NHK総合',       // ノルウェー×セネガル 6/23
  45: 'NHK総合',       // ポルトガル×ウズベキスタン 6/24
  47: 'フジテレビ',    // パナマ×クロアチア 6/24
  48: '日テレ',        // コロンビア×DRコンゴ 6/24
  49: 'NHK総合',       // スイス×カナダ 6/25
  50: 'NHK総合',       // ボスニア×カタール 6/25
  58: 'NHK総合',       // 日本×スウェーデン 6/26
  59: '日テレ',        // トルコ×アメリカ 6/26
  61: 'NHK総合',       // ノルウェー×フランス 6/27
  65: 'フジテレビ',    // ニュージーランド×ベルギー 6/27
  69: 'フジテレビ',    // コロンビア×ポルトガル 6/28
  71: 'NHK総合',       // アルジェリア×オーストリア 6/28
  72: 'NHK総合',       // ヨルダン×アルゼンチン 6/28
  // ラウンド32
  78: '日テレ',        // 7/1 2:00 E組2位×I組2位
  83: '日テレ',        // 7/3 8:00 K組2位×L組2位
  86: '日テレ',        // 7/4 7:00 J組1位×H組2位
  // ラウンド16
  93: '日テレ',        // 7/7 4:00
  95: '日テレ',        // 7/8 1:00
  // 3位決定戦・決勝
