...
// ─── 放送チャンネル（地上波がある試合も NHK BS/DAZN を併記） ─────────────
const CHANNELS = {
  // グループステージ（6/12〜6/16 は画像スケジュールより）
  1:  'NHK総合・NHK BS/DAZN',    // メキシコ×南アフリカ
  5:  'NHK総合・NHK BS/DAZN',    // カタール×スイス
  6:  'フジテレビ・NHK BS/DAZN', // ブラジル×モロッコ
  8:  '日テレ・NHK BS/DAZN',     // オーストラリア×トルコ
  10: 'NHK総合・NHK BS/DAZN',    // オランダ×日本
  13: 'NHK総合・NHK BS/DAZN',    // スペイン×カーボベルデ
  // 6/17〜 は goal.com 情報より
  17: 'フジテレビ・NHK BS/DAZN', // フランス×セネガル
  19: 'NHK総合・NHK BS/DAZN',    // アルゼンチン×アルジェリア
  21: 'フジテレビ・NHK BS/DAZN', // ポルトガル×DRコンゴ
  25: '日テレ・NHK BS/DAZN',     // チェコ×南アフリカ
  28: 'NHK総合・NHK BS/DAZN',    // メキシコ×韓国
  29: 'NHK総合・NHK BS/DAZN',    // アメリカ×オーストラリア
  30: 'フジテレビ・NHK BS/DAZN', // スコットランド×モロッコ
  31: 'NHK総合・NHK BS/DAZN',    // ブラジル×ハイチ
  33: 'NHK総合・NHK BS/DAZN',    // オランダ×スウェーデン
  34: '日テレ・NHK BS/DAZN',     // ドイツ×コートジボワール
  36: '日テレ・NHK BS/DAZN',     // チュニジア×日本（NHK BS生+日テレ）
  37: 'NHK総合・NHK BS/DAZN',    // スペイン×サウジアラビア
  43: 'NHK総合・NHK BS/DAZN',    // ノルウェー×セネガル
  45: 'NHK総合・NHK BS/DAZN',    // ポルトガル×ウズベキスタン
  47: 'フジテレビ・NHK BS/DAZN', // パナマ×クロアチア
  48: '日テレ・NHK BS/DAZN',     // コロンビア×DRコンゴ
  49: 'NHK総合・NHK BS/DAZN',    // スイス×カナダ
  54: 'NHK総合・NHK BS/DAZN',    // チェコ×メキシコ
  58: 'NHK総合・NHK BS/DAZN',    // 日本×スウェーデン
  59: '日テレ・NHK BS/DAZN',     // トルコ×アメリカ
  61: 'NHK総合・NHK BS/DAZN',    // ノルウェー×フランス
  64: '日テレ・NHK BS/DAZN',     // ウルグアイ×スペイン
  65: 'フジテレビ・NHK BS/DAZN', // ニュージーランド×ベルギー
  69: 'フジテレビ・NHK BS/DAZN', // コロンビア×ポルトガル
  72: 'NHK総合・NHK BS/DAZN',    // ヨルダン×アルゼンチン
  // ラウンド32
  78: '日テレ・NHK BS/DAZN',     // 7/1 2:00
  83: '日テレ・NHK BS/DAZN',     // 7/3 8:00
  86: '日テレ・NHK BS/DAZN',     // 7/4 7:00
  // ラウンド16
  89: '日テレ・NHK BS/DAZN',     // 7/5 6:00
  93: '日テレ・NHK BS/DAZN',     // 7/7 4:00
  // 3位決定戦・決勝
  103: 'NHK総合・NHK BS/DAZN',
  104: 'NHK総合・NHK BS/DAZN',
};
